<template>
  ...
  <div>
    ...
    <mu-container>
      ...
      <div class="subForm">
        <p>试卷总分：{{sumMark}}</p>
        <mu-button color="success" @click.prevent="alterForm">修改试卷</mu-button>
        <mu-button color="error" @click.prevent="delteForm">删除试卷</mu-button>
      </div>
    </mu-container>
  </div>
</template>
